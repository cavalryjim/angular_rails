...
class FreelanceDocumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create freelance_document" do
    assert_difference('FreelanceDocument.count') do
      post freelance_documents_url, params: { freelance_document: { file_url: @freelance_document.file_url, image_url: @freelance_document.image_url, title: @freelance_document.title } }, as: :json
    end
  ...
  test "should update freelance_document" do
    patch freelance_document_url(@freelance_document), params: { freelance_document: { file_url: @freelance_document.file_url, image_url: @freelance_document.image_url, title: @freelance_document.title } }, as: :json
    assert_response 200
  end
